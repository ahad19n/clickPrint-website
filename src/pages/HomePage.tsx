  ...
  return (
    <section className="relative overflow-hidden">
      <div
        ...
        style={{
          background:
            'radial-gradient(1000px 520px at 82% -8%, rgba(59,158,255,.10), transparent 60%),radial-gradient(760px 480px at 6% 12%, rgba(0,217,163,.09), transparent 62%)',
        }}
      />
      <div className="cp-in relative grid grid-cols-[1.02fr_.98fr] gap-10 items-center pt-16 pb-[76px]">
        {/* copy */}
        <div>
          <div className="cp-rise [animation-delay:.02s] inline-flex items-center gap-[9px] bg-[rgba(0,217,163,.12)] text-green-dark font-bold text-[12.5px] px-[14px] py-2 rounded-[30px] mb-[22px]">
          ...
          <h1 className="cp-rise [animation-delay:.08s] font-sora font-extrabold text-[56px] leading-[1.04] tracking-[-1.5px] mb-5">
            ...
            <span className="bg-gradient-to-br from-[#1b3a6b] to-[#18b8c9] bg-clip-text text-transparent">
              goldmine.
            </span>
          </h1>
          <p className="cp-rise [animation-delay:.14s] text-[18.5px] leading-[1.6] text-body max-w-[520px] mb-8">
            Click Print streams thousands of pre‑paid student print jobs straight to your shop. You
            print, you earn — no new hardware, no chasing customers.
          </p>
          <div className="cp-rise [animation-delay:.2s] flex flex-wrap gap-[14px] items-center">
            <button
              onClick={onRegister}
              className="cp-btn-primary border-none cursor-pointer font-manrope font-bold text-base text-white bg-coral px-[30px] py-4 rounded-[14px] animate-[cpPulse_2.6s_ease-in-out_infinite]"
            >
          ...
          <div className="absolute left-[2%] top-[26px] w-[214px] h-[428px] bg-navy rounded-[38px] p-[11px] shadow-[0_30px_60px_rgba(18,35,63,.28)] animate-[cpBob_5s_ease-in-out_infinite]">
            <div className="w-full h-full bg-cloud rounded-[29px] overflow-hidden relative">
              ...
              <div className="pt-[34px] px-4">
                ...
                <div className="text-[11px] text-muted mt-[2px] font-semibold">
                  Nova Print · Main Campus
                </div>
                {/* doc card */}
                <div className="mt-4 bg-white rounded-2xl p-[14px] shadow-[0_8px_20px_rgba(143,155,179,.12)]">
                  <div className="flex gap-[10px] items-center">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-[10.5px] text-muted font-semibold mt-[2px]">
                        24 pages · Color · A4
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-[14px] bg-green rounded-[13px] p-3 flex items-center justify-center gap-2 shadow-[0_10px_22px_rgba(0,217,163,.32)] animate-[cpTap_3.2s_ease-in-out_infinite]">
                  <span className="text-white font-sora font-bold text-[13.5px]">
                    Pay &amp; send to shop
                  </span>
                </div>
              </div>
          ...
          <div className="absolute right-[3%] bottom-5 w-[210px]">
            ...
            <div className="relative z-[2] bg-gradient-to-br from-[#243a63] to-navy rounded-t-[20px] rounded-b-2xl px-4 pt-4 pb-5 shadow-[0_24px_44px_rgba(18,35,63,.3)]">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="font-sora font-bold text-[11px] text-white/70 tracking-[.5px]">
                  CLICK PRINT
                </div>
              </div>
        ...
        <div className="bg-navy rounded-[28px] px-[30px] py-[38px] grid grid-cols-4 gap-5 shadow-[0_30px_60px_rgba(18,35,63,.22)] relative overflow-hidden">
          ...
          {stats.map((s) => (
            <div key={s.label} className="relative">
              <div className={`font-sora font-extrabold text-[38px] tracking-[-1px] ${s.color}`}>
                {s.value}
              </div>
    ...
    <section id="how" className="pt-[60px] pb-5">
      <div className="cp-in">
        <div className="text-center max-w-[640px] mx-auto mb-[46px]">
          <div className="font-sora font-bold text-[13px] tracking-[.6px] text-blue uppercase">
            Up and running in a day
          </div>
          <h2 className="font-sora font-extrabold text-[40px] tracking-[-1px] mt-3">
            How Click Print works for you
          </h2>
        </div>
        <div className="grid grid-cols-4 gap-5">
          {steps.map((s) => (
            <div
              key={s.n}
              className="cp-card-hover bg-white rounded-[22px] px-[22px] py-[26px] shadow-[0_2px_10px_rgba(143,155,179,.1)]"
            >
              <div
                className={`w-12 h-12 rounded-[14px] font-sora font-extrabold text-xl flex items-center justify-center ${s.badge}`}
              >
                {s.n}
              </div>
    ...
    <section id="why" className="pt-16 pb-5">
      <div className="cp-in">
        <div className="max-w-[640px] mb-11">
          <div className="font-sora font-bold text-[13px] tracking-[.6px] text-green-dark uppercase">
            Why partner with us
          </div>
          <h2 className="font-sora font-extrabold text-[40px] tracking-[-1px] mt-3">
            More income from the printer you already own
          </h2>
        </div>
        <div className="grid grid-cols-3 gap-[22px]">
          <div className="cp-card-hover bg-coral rounded-3xl p-[30px] text-white shadow-[0_18px_40px_rgba(255,139,123,.32)]">
            <div className="w-[52px] h-[52px] rounded-[15px] bg-white/20 flex items-center justify-center text-2xl">
              💸
            </div>
            <h3 className="font-sora font-bold text-[21px] mt-5 mb-[10px]">
              Earn more, effortlessly
            </h3>
            <p className="text-[15px] leading-[1.62] text-white/[.92]">
              A steady stream of pre‑paid jobs fills your idle hours — every order is money in the
              bank before you print a page.
            </p>
          </div>
          <div className="cp-card-hover bg-blue rounded-3xl p-[30px] text-white shadow-[0_18px_40px_rgba(59,158,255,.32)]">
            ...
            <h3 className="font-sora font-bold text-[21px] mt-5 mb-[10px]">
              Reach every student nearby
            </h3>
            <p className="text-[15px] leading-[1.62] text-white/[.92]">
              Get discovered by thousands of students on nearby campuses — no flyers, no ads, no
              walk‑in luck required.
            </p>
          </div>
          <div className="cp-card-hover bg-green rounded-3xl p-[30px] text-[#063d31] shadow-[0_18px_40px_rgba(0,217,163,.32)]">
            <div className="w-[52px] h-[52px] rounded-[15px] bg-white/[.28] flex items-center justify-center text-2xl">
              ⚡
            </div>
            ...
            <p className="text-[15px] leading-[1.62] text-[rgba(6,61,49,.82)]">
              Keep your printer. No new machines, no monthly fee, no commitment. Free to join and
              free to pause any time.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="cp-in">
        <div className="bg-gradient-to-br from-[#1b3a6b] to-navy rounded-[30px] p-[52px] grid grid-cols-[1.2fr_.8fr] gap-11 items-center relative overflow-hidden shadow-[0_30px_70px_rgba(18,35,63,.28)]">
          ...
          <div className="relative">
            <div className="font-sora font-bold text-[13px] tracking-[.6px] text-[#18b8c9] uppercase">
              The Click Print app
            </div>
            ...
            <p className="text-white/[.72] text-base leading-[1.62] max-w-[440px] mb-7">
              Accept orders, track your print queue, toggle your shop online, and watch your weekly
              earnings grow — all from one app. Scan the code or grab it from your store.
            </p>
            <div className="flex flex-wrap gap-[14px]">
              ...
              >
                ...
                <span className="leading-[1.1]">
                  <span className="block text-[10px] text-[#b9b9b9] font-semibold">
                    Download on the
                  </span>
          ...
          <div className="relative flex justify-center">
            <div className="bg-white rounded-[26px] p-5 shadow-[0_24px_50px_rgba(0,0,0,.3)]">
              <img
                src={qrCode}
                alt="Scan to download Click Print"
                className="w-[196px] h-[196px] block rounded-xl"
              />
              <div className="text-center mt-3 font-sora font-bold text-[13.5px] text-ink">
                Scan to download
              </div>
              <div className="text-center text-[11.5px] text-muted font-semibold mt-[2px]">
...
function Testimonials() {
  const items = [
    {
      quote:
        '“My printer used to sit idle till noon. Now I get 40–60 pre‑paid jobs before the first class ends. It’s honestly changed my month.”',
      initial: 'A',
    ...
    {
      quote:
        '“No arguing over prices, no cash handling, no ‘can you rush this’. Orders come in clean and paid. Payouts hit my account every Friday.”',
      initial: 'S',
    ...
    {
      quote:
        '“Signing up took me ten minutes and cost nothing. I toggle the shop off when I’m swamped and back on when I’m free. Total control.”',
      initial: 'B',
      ...
      <div className="cp-in">
        ...
        <div className="grid grid-cols-3 gap-[22px]">
          {items.map((t) => (
            <div
              key={t.name}
              className="cp-card-hover bg-white rounded-[22px] p-7 shadow-[0_2px_12px_rgba(143,155,179,.12)]"
            >
              <div className="text-coral text-[15px] tracking-[2px]">★★★★★</div>
              <p className="text-[15.5px] leading-[1.65] text-[#37405c] mt-[14px] mb-[22px] font-medium">
                {t.quote}
              </p>
